...
export const query = graphql`
  query IndexPageQuery {
    ...
    selectedProducts: allSanityProduct(
      filter: {title: {fr: {in: ["Kan ar Bed - Livre-CD", "Bwouf ! Allo Bill ?", "The Hobbit (relié)", "L'imagier breton-anglais de Petit Ours Brun", "Les 12 travaux d'Astérix & Astérix et Cléopâtre", "Fililoup chevalier"]}}}
      sort: {order: [DESC, DESC], fields: [releaseDate]}
      ) {
      edges {
        node {
